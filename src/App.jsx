        ...
        <div className="story-sections">
          <section className="content-section editorial-section" id="introduction" aria-labelledby="introduction-heading">
            ...
            <div className="editorial-body">
              <p>In order to keep abreast with rapid technological advancements and evolving requirements in industries today, Department of Polytechnic &amp; College Community Education (POLYCC) has worked collaboratively with the nation&apos;s key industry players in developing and reviewing the curriculum of Information and Communication Technology (ICT) programme. This collaboration aims to equip students with timely knowledge and relevant skills to meet the global challenges and the requirements of the ICT industries. In achieving integrated learning, this aim pedagogy that blends classroom instructions with structured simulated real-life working experience is fully utilised to prepare students for the competitive edge in today&apos;s workplace.</p>
              <p>The growing demand for highly skilled and technically savvy workplace drives the need to produce area for qualified men power in this industry to remain competitive in the world market. To address these issues the Curriculum Division (CD), POLYCC cooperates with the industries, Private Higher Learning Institutions and Public Higher Learning Institutions to develop and review the curriculum of the ICT programme. This curriculum integrates with the curriculum of professional certification and industry-led curriculum such as Computer Technology Industry Association (CompTIA A+), Oracle Java Certification, Microsoft Computer System Administrator (MCSA) and Microsoft Certified Desktop Service Technician (MCDST), Cisco Certified Network Associates (CCNA), EC-Council Network Security (ENSA), Certified Ethical Hacker (CEH), Amazon Web Services (AWS), Google analytic, Data science, Machine learning with python, Python and Infosys Campus Connect program, to give the opportunities for the students to sit for professional certificate examinations by the end of the final semester. This will give students added value and ensure that the knowledge and skills acquired through this programme are relevant with the needs of the ICT industries.</p>
          ...
          <section className="content-section curriculum-section" id="curriculum" aria-labelledby="curriculum-heading">
            ...
            <p className="curriculum-legend">Legend: L : Lecture · P : Practical / Lab · T : Tutorial · CR : Credit Hours</p>
          ...
          {shellSections.filter(([id]) => !['introduction', 'synopsis', 'careers', 'direction', 'peo', 'plo', 'curriculum', 'industry-advisors'].includes(id)).map(([id, number, label]) => (
